        ...
        <Card className="border-border/50 bg-card/50 backdrop-blur rounded-xl overflow-hidden relative">
          ...
          <div className="relative z-10">
            <CardHeader className="pb-6 border-b border-border/30 text-center">
              ...
              <CardDescription className="text-base mt-2 text-muted-foreground">Sign into your account (admin or reporter)</CardDescription>
            </CardHeader>
            ...
            <form onSubmit={handleSubmit}>
              <CardContent className="flex flex-col gap-5 pt-6">
                ...
                <div className="rounded-lg bg-primary/10 border border-primary/30 p-4 backdrop-blur">
                  <p className="text-xs font-bold text-primary uppercase tracking-wider"><span>Demo:</span> alice@example.com / password123</p>
                </div>
              </CardContent>
              ...
              <CardFooter className="flex flex-col gap-4 pt-4 border-t border-border/30">
                ...
                <p className="text-center text-sm text-muted-foreground">
                  Don't have account?{" "}
                  <Link href="/register" className="font-bold text-secondary hover:text-primary transition-colors">
                    Create One
                  </Link>
                </p>
              </CardFooter>
